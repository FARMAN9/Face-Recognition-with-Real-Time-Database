    ...
    if counter != 0:
        if counter == 1:
            ...
            if secondsElapsed > 30:
                ...
                counter = 0
                """ here need fix"""
                resizedImgMode = cv2.resize(imgModeList[modeType], (272, 633))

# Now place the resized image into the target region
imgBackground[44:44 + 633, 808:808 + 272] = resizedImgMode
        if modeType != 3:
