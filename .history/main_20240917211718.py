...
while True:
    ...
    imgBackground[50:50 + 648, 500:500 +
                  438] = imgModeList[modeType]
                  """
    target_height, target_width = imgModeList[modeType].shape[:2]
    imgBackground[50:50 + target_height, 500:500 +
                  target_width] = imgModeList[modeType]
    ...
    if counter != 0:
        if counter == 1:
            ...
            if secondsElapsed > 30:
                ...
                counter = 0
                """ here need fix"""
                resizedImgMode = cv2.resize(imgModeList[modeType], (438, 648))
                imgBackground[50:50 + 648, 500:500 +
                              438] = resizedImgMode
        ...
        if modeType != 3:
            ...
            resizedImgMode = cv2.resize(imgModeList[modeType], (414, 633))
            ...
            if counter <= 10:
                ...
                # Resize imgStudent to fit the target region's exact shape (171x216)
                resizedImgStudent = cv2.resize(imgStudent, (171, 216))

# Now place it in the target region of imgBackground
                imgBackground[175:175 + 216, 909:909 + 171] = resizedImgStudent
...
while True:
    ...
    if modeType < len(imgModeList):
        ...
        target_height, target_width = imgBackground[50:50 + 648, 500:500 + 438].shape[:2]
    ...
    imgs = cv2.resize(img, (0, 0), None, 0.25, 0.25)
    imgs = cv2.cvtColor(imgs, cv2.COLOR_BGR2RGB)  # Changed COLOR_RGBA2RGB to COLOR_BGR2RGB
