        ...
        if modeType != 3:
            ...
            if modeType < len(imgModeList):
                ...
                if counter <= 10:
                    ...
                    cv2.putText(imgBackground, str(studentInfo['major']), (1000, 100),
                                cv2.FONT_HERSHEY_COMPLEX, 0.8, (0, 0, 0), 1)
                    cv2.putText(imgBackground, str(id), (100, 550),
                                cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 1)
                    cv2.putText(imgBackground, str(studentInfo['standing']), (1000, 680),
                    ...
                    offset = (414 - w) // 2
                    cv2.putText(imgBackground, str(studentInfo['name']), (500 + offset, 445),
